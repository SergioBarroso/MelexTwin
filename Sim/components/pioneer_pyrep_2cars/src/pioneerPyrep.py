...
if __name__ == '__main__':
    ...
    adapter = ic.createObjectAdapter('GpsUbloxMulti')
    adapter.add(gpsubloxmultiI.GpsUbloxMultiI(worker), ic.stringToIdentity('gpsubloxmulti'))
    adapter.activate()
    ...
    adapter = ic.createObjectAdapter('CameraRGBDSimpleMulti')
    adapter.add(camerargbdsimpleI.CameraRGBDSimpleI(worker), ic.stringToIdentity('camerargbdsimplemulti'))
    adapter.activate()
    ...
    adapter = ic.createObjectAdapter('FullPoseEstimationMulti')
    adapter.add(fullposeestimationmultiI.FullPoseEstimationMultiI(worker), ic.stringToIdentity('fullposeestimationmulti'))
    adapter.activate()
