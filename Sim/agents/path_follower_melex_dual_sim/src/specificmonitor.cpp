...
//	params["InnerModelPath"] = aux;
	...
	params["3d_view"] = aux;
    configGetString( "","acc_from_pose", aux.value, "none");
    params["acc_from_pose"] = aux;
    ...
    configGetString( "","lookahead_distance", aux.value,"2000");
    params["lookahead_distance"] = aux;

    configGetString( "","current_path_name", aux.value,"");
    params["current_path_name"] = aux;

    configGetString( "","robot_name", aux.value, "none");
    params["robot_name"] = aux;
    configGetString( "","mind_name", aux.value, "none");
    params["mind_name"] = aux;
    configGetString( "","task_name", aux.value, "none");
    params["task_name"] = aux;
}
