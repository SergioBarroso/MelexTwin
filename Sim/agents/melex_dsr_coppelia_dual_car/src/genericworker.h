...
using TuplePrx = std::tuple<RoboCompCameraRGBDSimpleMulti::CameraRGBDSimpleMultiPrxPtr,RoboCompDifferentialRobotMulti::DifferentialRobotMultiPrxPtr,RoboCompFullPoseEstimationMulti::FullPoseEstimationMultiPrxPtr,RoboCompGpsUbloxMulti::GpsUbloxMultiPrxPtr,RoboCompLaserMulti::LaserMultiPrxPtr>;
